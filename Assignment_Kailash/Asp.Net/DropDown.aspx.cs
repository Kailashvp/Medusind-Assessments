...
namespace ValidationForm
{
    public partial class DropDown : System.Web.UI.Page
    {
        ...
        {
            string connectionString = "Data Source=kailash22\\SQLEXPRESS; initial catalog=master;integrated security = true;";
            SqlConnection con = new SqlConnection(connectionString);
            SqlCommand command = new SqlCommand("GetChocolateProducts", con);
