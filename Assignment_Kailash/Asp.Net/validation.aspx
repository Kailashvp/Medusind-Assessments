...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 style="color:royalblue">Insert Your Details:</h1></div>
        <p>
            Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Txtaddress" ErrorMessage="Atleast 2 Chars Plz" ForeColor="Red" ValidationExpression="^.*[a-zA-Z]{2,}.*$"></asp:RegularExpressionValidator>
        </p>
        <p>
            City :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="Txtcity" ErrorMessage="Atleast 2 Chars Plz" ForeColor="Red" ValidationExpression="^.*[a-zA-Z]{2,}.*$"></asp:RegularExpressionValidator>
        </p>
        <p>
            Zip Code :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
